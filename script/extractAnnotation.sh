...
ANNOTDIR=../virusDB/application/Small_ACCs
...
do
    ...
    bfvd_logan=$(grep -c 'hypothetical' phage_annotation/logan/$contig"_besthits.tab")
    #AFDB + BFVD
    afdb_bfvd=$(awk -F"\t" '$1~/hypothetical/ {split($1,file,".pdb");print file[1]}'  $dir/INHERIT_phages/foldseek_hits/$contig"_besthits.tab" phage_annotation/logan/$contig"_besthits.tab"| sort -u | wc -l)
